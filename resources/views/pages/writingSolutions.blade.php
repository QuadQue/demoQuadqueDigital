...
@section('title', 'Writing Solutions - Quadque Digital')
@push('styles')
<style>
    .artwork-2 {
...
<div class="page-header position-relative">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="paragraph dark-1">
                        <p>Good Writing Leads Your Customers Through a Funnel

                            Effective business writing helps trust in you and your organization. With accurate deadlines and spellcheck, each piece of writing should be well-written in order to create credibility and reliability. Creativity is our primary goal. We ideate and design content with words. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="page-header-bottom">
        <div class="single-image">
            <img src="{{asset('assets/images/service_images/content-writing-1.jpg')}}" alt="about-header">
        </div>
    </div>
...
<div class="text-content">
    ...
    <div class="single-image ">
        <img src="{{asset('assets/images/service_images/content-writing-2.jpg')}}" alt="generic-image">
    </div>
</div>
