...
@section('title', 'Online Advertising - Quadque Digital')
@push('styles')
<style>
    .artwork-2 {
...
<div class="page-header position-relative">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="paragraph dark-1">
                        <p>Online Advertising is a type of commercial communication in which a product, service, or concept is promoted or sold via the use of openly sponsored, attractive messages. Advertising is often sponsored by businesses seeking to advertise their products or services.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="page-header-bottom">
        <div class="single-image">
            <img src="{{asset('assets/images/service_images/online-advertising.jpg')}}" alt="about-header">
        </div>
    </div>
...
<div class="text-content">
    ...
    <div class="single-image ">
        <img src="{{asset('assets/images/service_images/online-advertising-2.jpg')}}" alt="generic-image">
    </div>
</div>
