...
@section('title', 'Design & Photography - Quadque Digital')
@push('styles')
<style>
    .artwork-2 {
...
<div class="page-header position-relative">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="paragraph dark-1">
                        <p>A design is a plan or specification for the building of an item or system or for the implementation of an activity or process, or the output of that plan or extremely detailed of a prototype, 
                        product or process. A good design raises the value of your business, promotes sales, and puts your firm in a better financial position.
                         This service includes the overall design part for a company.
                            Excellent design helps to your company’s profitability through building trust, creating great first impressions, building client relationships, and even executing effective campaigns.
    ...
    <div class="page-header-bottom">
        <div class="single-image">
            <img src="{{asset('assets/images/service_images/design-photography-1.jpg')}}" alt="about-header">
        </div>
    </div>
...
<div class="text-content">
    ...
    <div class="single-image ">
        <img src="{{asset('assets/images/service_images/design-photography-2.jpg')}}" alt="generic-image">
    </div>
</div>
