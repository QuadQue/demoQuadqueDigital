...
@section('title', 'Project Detailed - Quadque Digital')
@section('content')
        ...
        <div class="project-single--header">
             <div class="container">
                 <div class="heading heading-very-large dark-1">
                     <h1>Sleep therapy’s product landing page design with ecommerce integration.</h1>
                 </div>
             </div>
                     ...
                     <div class="row">
                        <div class="col-md-3">                        
                            <div class="project-single-client">
                                ...
                                <h3 class="heading heading-small dark-1">Comfort</h3>
                            </div> 
                        </div>
                        <div class="col-md-3">
                            <div class="project-single-service">
                                <h4 class="heading heading-small dark-2">Services</h4>
                                <h3 class="heading heading-small dark-1">UI/UX Design</h3>
                            </div>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="single-image">
                        <img src="assets/images/project_slide_img_1.jpg" alt="project_detailed_img1">
                    </div>
                </div>
  
                <div class="swiper-slide">
                    <div class="single-image">
                        <img src="assets/images/project_slide_img_1.jpg" alt="project_detailed_img2">
                    </div>
                </div>
            
                <div class="swiper-slide">
                    <div class="single-image">
                        <img src="assets/images/project_slide_img_1.jpg" alt="project_detailed_img3">
                    </div>
                </div>
    ...
    <div class="project-content">
        <div class="project-content-wrapper">
            ...
            <div class="single-image-wrapper">
                <div class="single-image">
                    <img src="assets/images/project_detailed_img_2.jpg" alt="project-detailed-2">
                </div>
                <div class="single-image">
                    <img src="assets/images/project_detailed_img_3.jpg" alt="project-detailed-3">
                </div>
            </div>
            <div class="container">
                <div class="row">
            ...
            <div class="single-image">
                <img src="assets/images/project_detailed_img_4.jpg" alt="project-detailed-4">
            </div>
        </div>
    </div>
    <!-- project content - end -->
    ...
    <div class="text-content">
        <div class="text-content-wrapper position-relative bg-black">
           ...
           {{--  <div class="artwork artwork-2">
                <img src="{{ asset('assets/images/art_1.svg') }}" width="582" height="669" alt="artwork-2">
