...
@section('title', 'Video & Animations - Quadque Digital')
@push('styles')
<style>
    .artwork-2 {
...
<div class="page-header position-relative">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="heading heading-very-large dark-1">
                       Display Your Services and Products Creatively

                    </h1>
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="paragraph dark-1">
                        <p>Using animated videos is a time-tested method of increasing conversions and revenue. Including video on a landing page may boost conversions by up to 80%. Videos have the potential to increase sales both directly and indirectly. Prospects enjoy visualizing themselves utilizing the things they wish to purchase. Animated explainer movies can be used to demonstrate to visitors how a product, service, or your business works.</p>
    ...
    <div class="page-header-bottom">
        <div class="single-image">
            <img src="{{ asset('assets/images/service_images/video-animation-1.jpg') }}" alt="about-header">
...
<div class="text-content">
    ...
    <div class="single-image ">
        <img src="{{ asset('assets/images/service_images/video-animation-2.jpg') }}" alt="generic-image" height="766">
