...
<div class="text-content">
    ...
    <div class="single-image ">
        <img src="{{ asset('assets/images/service_images/socail_media_marketing_2.jpg') }}" alt="generic-image" height="766">
