...
@section('title', 'Content Marketing - Quadque Digital')
@push('styles')
<style>
...
@section('content')
    ...
    <div class="page-header position-relative">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="paragraph dark-1">
                            <p>Content marketing is a type of marketing strategy that entails developing and 
                                sharing relevant articles, blogs, videos, podcasts, and other forms of
                                 media in order to attract, engage, and keep an audience. This method creates expertise,
                                  increases brand recognition, and keeps your business at the forefront
                                   of your mind when the time comes to purchase what you sell.
                            Content Marketing is very important for any business development.
                              </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-header-bottom">
            <div class="single-image">
                <img src="{{asset('assets/images/service_images/content-marketing-1.jpg')}}" alt="about-header">
              </div>
        </div>
    ...
    <div class="text-content">
        ...
        <div class="single-image ">
            <img src="{{asset('assets/images/service_images/content-marketing-2.jpg')}}" alt="generic-image">
        </div>
    </div>
