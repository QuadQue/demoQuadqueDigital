...
@section('title', 'Programming & Technology - Quadque Digital')
@push('styles')
<style>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="paragraph dark-1">
                            <p>Programming & Tech is an essential part of a company. Without technology, we can’t move forward in this global world. To make your business more attractive and fruitful, convert your business from traditional to digital.
                                This service includes all the advanced technological solutions with programming languages.
Web development and design help to promote a company’s brand name and services.
A mobile application utilizes a network connection to work with remote computing resources.
 </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-header-bottom">
            <div class="single-image">
                <img src="{{asset('assets/images/service_images/prog-tech-1.jpg')}}" alt="about-header">
              </div>
        </div>
    ...
    <div class="text-content">
        ...
        <div class="single-image ">
            <img src="{{asset('assets/images/service_images/prog-tech-2.jpg')}}" alt="generic-image">
        </div>
    </div>
