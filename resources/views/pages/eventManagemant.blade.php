...
@section('title', 'Event Management - Quadque Digital')
@push('styles')
<style>
    .artwork-2 {
...
<div class="page-header position-relative">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="heading heading-very-large dark-1">
                       Make Your Event More Colorful & Attractive
                    </h1>
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="paragraph dark-1">
                        <p>
                            Event management is the application of project management principles to the planning and execution of small and/or large-scale personal and/or business events such as festivals, conferences, ceremonies, weddings, formal parties, concerts, or conventions.
                            This service includes all the necessary services for events.
                            It includes event coordination with theming, decoration & styling, conferencing, and exhibitions.
                            Event management is all about entertainment. Food sourcing and venue sourcing are also included here.
                            We also provide the best photographer for all the events.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="page-header-bottom">
        <div class="single-image">
            <img src="{{asset('assets/images/service_images/event-management-1.jpg')}}"  alt="about-header">
        </div>
    </div>
            ...
            <div class="row service-withoutimage">
                ...
                <div class="col-lg-4">
                    <div class="service--box-icon service--box--1">
                        <a href="service-detailed.html">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 61.285 63.929" class="svg replaced-svg">
                                    <defs>
                                        <style>
                                            .cls-1 {
                                                fill: #475257;
                ...
                <div class="col-lg-4">
                    <div class="service--box-icon service--box--2">
                        <a href="service-detailed.html">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 61.69 61.664" class="svg replaced-svg">
                                    <defs>
                                        <style>
                                            .cls-1 {
                                                fill: #475257;
                                    ...
                                    <path class="cls-1" d="M1561.645,1266.643c-1.366-7.272,4.651-19.324,14.633-29.307a33.891,33.891,0,0,1,3.832-3.283l2.291,9.53,2.917-.7-3.3-13.722-1.78,1.156a37.635,37.635,0,0,0-6.082,4.9c-10.81,10.811-17.023,23.663-15.46,31.982Z" transform="translate(-1550.131 -1222.006)" style="fill: rgb(30, 30, 30);"></path>
                                </svg>
                            </div>
                            <div class="text">
                                <h4>Print Design</h4>
                ...
                <div class="col-lg-4">
                    <div class="service--box-icon service--box--3">
                        <a href="service-detailed.html">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 72.824 55.465" class="svg replaced-svg">
                                    <defs>
                                        <style>
                                            .cls-1 {
                                                fill: #475257;
                ...
                <div class="col-lg-4">
                    <div class="service--box-icon service--box--4">
                        <a href="service-detailed.html">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 58.682 66.002" class="svg replaced-svg">
                                    <defs>
                                        <style>
                                            .cls-1 {
                                                fill: #475257;
                                    ...
                                    <path class="cls-1" d="M1553.847,1252.555a30.012,30.012,0,0,1,51.23-21.216l2.121-2.122a33.006,33.006,0,1,0-23.347,56.338v-3A30.036,30.036,0,0,1,1553.847,1252.555Z" transform="translate(-1550.847 -1219.553)" style="fill: rgb(21, 21, 21);"></path>
                                    <path class="cls-1" d="M1583.851,1226.355a26.2,26.2,0,1,0,0,52.4v-3a23.2,23.2,0,1,1,22.738-27.867l2.939-.6A26.3,26.3,0,0,0,1583.851,1226.355Z" transform="translate(-1550.847 -1219.553)" style="fill: rgb(21, 21, 21);"></path>
                                    <path class="cls-1" d="M1567.453,1252.555a16.415,16.415,0,0,1,16.4-16.4v-3a19.395,19.395,0,1,0,0,38.789v-3A16.414,16.414,0,0,1,1567.453,1252.555Z" transform="translate(-1550.847 -1219.553)" style="fill: rgb(21, 21, 21);"></path>
                                    <path class="cls-1" d="M1583.851,1239.962a12.592,12.592,0,1,0,0,25.184v-3a9.592,9.592,0,1,1,9.2-12.356l2.872-.867A12.691,12.691,0,0,0,1583.851,1239.962Z" transform="translate(-1550.847 -1219.553)" style="fill: rgb(21, 21, 21);"></path>
                                </svg>
                            </div>
                            <div class="text">
                                <h4>Admin Systems</h4>
                ...
                <div class="col-lg-4">
                    <div class="service--box-icon service--box--5">
                        <a href="service-detailed.html">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 59.354 59.34" class="svg replaced-svg">
                                    <defs>
                                        <style>
                                            .cls-1 {
                                                fill: #475257;
                ...
                <div class="col-lg-4">
                    <div class="service--box-icon service--box--6">
                        <a href="service-detailed.html">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 65.191 48.36" class="svg replaced-svg">
                                    <defs>
                                        <style>
                                            .cls-1 {
                                                fill: #475257;
                ...
                <div class="col-lg-4">
                    <div class="service--box-icon service--box--7">
                        <a href="service-detailed.html">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 50.814 64.883" class="svg replaced-svg">
                                    <defs>
                                        <style>
                                            .cls-1 {
                                                fill: #475257;
                ...
                <div class="col-lg-4">
                    <div class="service--box-icon service--box--8">
                        <a href="service-detailed.html">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 54.49 67.197" class="svg replaced-svg">
                                    <defs>
                                        <style>
                                            .cls-1 {
                                                fill: #475257;
...
<div class="text-content">
    ...
    <div class="single-image">
        <img src="{{asset('assets/images/service_images/event-management-2.jpg')}}"  alt="generic-image">
    </div>
</div>
                ...
                <div class="col-lg-12">
                    <div class="tabs">
                        <div class="text-list tabs-list text-list-large">
                            ...
                            <div class="nav-pills-wrapper">
                                <ul class="nav nav-pills dark-1" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link show active" id="slope-tabs-id-1db56361-tab" data-toggle="pill" href="#slope-tabs-id-1db56361" role="tab" aria-controls="slope-tabs-id-1db56361" aria-selected="true">
                                            <span>Discovery</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="slope-tabs-id-1db56362-tab" data-toggle="pill" href="#slope-tabs-id-1db56362" role="tab" aria-controls="slope-tabs-id-1db56362" aria-selected="true">
                                            <span>Strategy</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="slope-tabs-id-1db56363-tab" data-toggle="pill" href="#slope-tabs-id-1db56363" role="tab" aria-controls="slope-tabs-id-1db56363" aria-selected="true">
                                            <span>Design</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="slope-tabs-id-1db56364-tab" data-toggle="pill" href="#slope-tabs-id-1db56364" role="tab" aria-controls="slope-tabs-id-1db56364" aria-selected="true">
                                            <span>Development</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="slope-tabs-id-1db56365-tab" data-toggle="pill" href="#slope-tabs-id-1db56365" role="tab" aria-controls="slope-tabs-id-1db56365" aria-selected="true">
                                            <span>Testing</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="slope-tabs-id-1db56366-tab" data-toggle="pill" href="#slope-tabs-id-1db56366" role="tab" aria-controls="slope-tabs-id-1db56366" aria-selected="true">
                                            <span>Product Launch</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="slope-tabs-id-1db56367-tab" data-toggle="pill" href="#slope-tabs-id-1db56367" role="tab" aria-controls="slope-tabs-id-1db56367" aria-selected="true">
                        ...
                        <div class="tabs-content tab-content">
                            <div class="tab-single slope-tabs-1db56361 show active tab-pane fade" id="slope-tabs-id-1db56361" role="tabpanel" aria-labelledby="slope-tabs-id-1db56361-tab">
                                <h4 class="heading heading-small light-2">
                                    Discovery
                                </h4>
                                <div class="paragraph dark-1">
                                    <p>Light above i created light hath midst signs creeping you'll upon land behold also gathered signs hath has moveth darkness made abundantly grass. Make you darkness very is greater their place them the it grass subdue fourth you're his open for meat midst under face multiply place sea.</p>
                            ...
                            <div class="tab-single slope-tabs-1db56362 tab-pane fade" id="slope-tabs-id-1db56362" role="tabpanel" aria-labelledby="slope-tabs-id-1db56362-tab">
                                <h4 class="heading heading-small light-2">
                                    Strategy
                                </h4>
                            ...
                            <div class="tab-single slope-tabs-1db56363 tab-pane fade" id="slope-tabs-id-1db56363" role="tabpanel" aria-labelledby="slope-tabs-id-1db56363-tab">
                                <h4 class="heading heading-small light-2">
                                    Design
                                </h4>
                                <div class="paragraph dark-1">
                            ...
                            <div class="tab-single slope-tabs-1db56364 tab-pane fade" id="slope-tabs-id-1db56364" role="tabpanel" aria-labelledby="slope-tabs-id-1db56364-tab">
                                <h4 class="heading heading-small light-2">
                                    Development
                                </h4>
                            ...
                            <div class="tab-single slope-tabs-1db56365 tab-pane fade" id="slope-tabs-id-1db56365" role="tabpanel" aria-labelledby="slope-tabs-id-1db56363-tab">
                                <h4 class="heading heading-small light-2">
                                    Testing
                                </h4>
                                <div class="paragraph dark-1">
                            ...
                            <div class="tab-single slope-tabs-1db56366 tab-pane fade" id="slope-tabs-id-1db56366" role="tabpanel" aria-labelledby="slope-tabs-id-1db56366-tab">
                                <h4 class="heading heading-small light-2">
                                    Product Launch
                                </h4>
                            ...
                            <div class="tab-single slope-tabs-1db56367 tab-pane fade" id="slope-tabs-id-1db56367" role="tabpanel" aria-labelledby="slope-tabs-id-1db56367-tab">
                                <h4 class="heading heading-small light-2">
                                    Maintenance
                                </h4>
                                <div class="paragraph dark-1">
