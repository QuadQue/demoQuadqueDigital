...
@section('title', 'Internation Training & Education Council - Quadque Digital')
    ...
    <div class="project-single--header">
        <div class="container">
            <div class="heading heading-very-large dark-1">
                <h1>International Training & Education Counsel - Obtain your nationally recognised qualification </h1>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="project-single-client">
                            ...
                            <h3 class="heading heading-small dark-1">Itec</h3>
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\itec\construction-engineers-discussion-.jpg')}}" alt="project_detailed_img1">
                </div>
            </div>

            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\itec\ITEC-Website-Image_Meat-Processing-1.jpg')}}" alt="project_detailed_img2">
            ...
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\itec\handsome-electrician-checking-electrical-box-with-2021-08-29-22-35-45-utc.jpg')}}" alt="project_detailed_img3">
            ...
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\itec\ssdfasdf.jpg')}}" alt="project_detailed_img3">

                </div>
            </div>
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\itec\unfinished-real-estate-2021-09-24-03-38-50-utc.jpg')}}" alt="project_detailed_img3">
...
<div class="project-content">
    <div class="project-content-wrapper">
        ...
        <div class="single-image-wrapper">
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\itec\223.png'}}" alt="project-detailed-2">

            </div>
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\itec\3.png'}}" alt="project-detailed-3">
        ...
        <div class="single-image" style="background-color:#13263f;">
            <div style="background-image:url({{asset('assets/images/project-detailed/itec/disability-and-22-39-57-utc.jpg')}}); height:600px; width:100%; opacity:0.2;background-size:cover">
