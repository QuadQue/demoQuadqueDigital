...
@section('title', 'Alpha Training and Recognitions - QuadQue Digital')
        ...
        <div class="project-single--header">
             <div class="container">
                 <div class="heading heading-very-large dark-1">
                     <h1>Alpha Training and Recognitions - Build a Career in the Construction and Building Industry.</h1>
                 </div>
             </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="single-image">
                        <img src="{{asset('assets\images\project-detailed\alpha\construction-slider-1.jpg')}}" alt="project_detailed_img1">
                    </div>
                </div>
  
                <div class="swiper-slide">
                    <div class="single-image">
                        <img src="{{asset('assets\images\project-detailed\alpha\construction-slider-2.jpg')}}" alt="project_detailed_img2">
                    </div>
                </div>
            
                <div class="swiper-slide">
                    <div class="single-image">
                        <img src="{{asset('assets\images\project-detailed\alpha\construction-slider-3.jpg')}}" alt="project_detailed_img3">
                    </div>
                </div>
    ...
    <div class="project-content">
        <div class="project-content-wrapper">
            ...
            <div class="single-image-wrapper">
                <div class="single-image">
                    <img src="{{'assets/images/project-detailed/alpha/image-06-1.jpg'}}" alt="project-detailed-2">
                </div>
                <div class="single-image">
                    <img src="{{'assets/images/project-detailed/alpha/image-18-1.jpg'}}" alt="project-detailed-3">
                </div>
            </div>
            <div class="container">
                <div class="row">
    ...
    <div class="text-content">
        <div class="text-content-wrapper position-relative bg-black">
            ...
            <div class="artwork artwork-2">
                <img src="{{ asset('assets/images/art_1.svg') }}">
