...
@section('title', 'Search Engine Optimization - Quadque Digital')
@push('styles')
<style>
    .artwork-2 {
...
<div class="page-header position-relative">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="paragraph dark-1">
                        <p>
                            Search Optimization services including the major Search Engine Optimization (SEO) is the process of optimizing your website in order to boost its exposure when consumers conduct searches on Google, Bing, and other search engines for items or services connected to your business. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="page-header-bottom">
        <div class="single-image">
            <img src="{{asset('assets/images/service_images/seo-search-engine-optimization-business-concept.jpg')}}" alt="about-header">
        </div>
    </div>
...
<div class="text-content">
    ...
    <div class="single-image ">
        <img src="{{asset('assets/images/service_images/seo-2.jpg')}}" alt="generic-image">
    </div>
</div>
