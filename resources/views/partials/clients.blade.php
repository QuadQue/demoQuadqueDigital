                             ...
                             <div class="swiper-wrapper">
                                 <div class="swiper-slide client-slide">
                                     <a href="#" class="client-image">
                                         <img src="{{ asset('assets/images/clients_logo/1-1-250x250-removebg-preview.png') }}" width="200" height="200" alt="otobi">

                                     </a>
                                 </div>
                                 <div class="swiper-slide client-slide">
                                     <a href="#" class="client-image">
                                         <img src="{{ asset('assets/images/clients_logo/13-250x250-removebg-preview.png') }}" width="200" height="200" alt="rupanjala ">
