...
<div class="bg-grey" id="category-section">
            ...
            <div class="col-md-4">
                <div id="blog-form">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.store.category') }}" method="POST" class="p-5">
                            @csrf
                               
                                <div class="form-group">
                                    <label for="category">Category Name</label>
                                    <input type="text" name="name" id="category" class="form-control  form-control-lg">
        ...
        <div class=" d-flex justify-content-center category-table  row ">
                    ...
                    <table class="table text-center">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td><a href="#editModal" data-toggle="modal" onclick="editCategory({{ $category->id }})" class="btn btn-info btn-lg mr-3">Edit</a><a href="#deleteModal" onclick="deleteCategory({{ $category->id }})" data-toggle="modal" class="btn btn-lg btn-warning">Delete</a></td>
